...
<div class="card">
  <div class="card-header flex-column flex-md-row">
    <div class="dt-action-buttons text-end pt-3 pt-md-0">
      <div>
        <h5 class=" float_left">Category</h5>
      </div>
    </div>
    <div class="dt-action-buttons text-end pt-3 pt-md-0">
      <div class="dt-buttons"> <a href="{{ route('admin.categories.create') }}"> <button class="btn btn-primary"
...
$(document).on('click', '.delete-record', function () {
    ...
    if (confirm('Are you sure you want to delete this Category?')) {
        $.ajax({
          url: "{{ url('admin/categories') }}/" + CategoryId, // Use the url() function
...
$(document).on('click', '.change-status', function () {
    var CategoryId = $(this).data('id');  
        $.ajax({
          url: "{{ url('admin/categories/status') }}/" + CategoryId, // Use the url() function
