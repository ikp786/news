...
<div class="card">
  <div class="card-header flex-column flex-md-row">
    <div class="dt-action-buttons text-end pt-3 pt-md-0">
      <div>
        <h5 class=" float_left">News</h5>
      </div>
    </div>
    <div class="dt-action-buttons text-end pt-3 pt-md-0">
      <div class="dt-buttons"> <a href="{{ route('admin.news.create') }}"> <button class="btn btn-primary"
...
$(document).on('click', '.delete-record', function () {
    ...
    if (confirm('Are you sure you want to delete this News?')) {
        $.ajax({
          url: "{{ url('admin/news') }}/" + CategoryId, // Use the url() function
            type: 'DELETE',
            data: {
...
$(document).on('click', '.change-status', function () {
    var CategoryId = $(this).data('id');  
        $.ajax({
          url: "{{ url('admin/news/status') }}/" + CategoryId, // Use the url() function
